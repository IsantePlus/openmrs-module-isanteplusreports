...
<div>
    ...
    <h1>${ ui.message("isanteplusreports.derl.surveillance.report") }</h1>
        	...
        	<div id="div4" class="togglable" style="display: none;">
	            <fieldset id="run-report" style="float:right; min-width: 450px; margin-left: 10px;">
	                <legend>
	                 ...
	                 <p>  <input type="checkbox" id="check" name="check" >${ ui.message("isanteplusreports.pnls.select.all") }</input></p><br/>
