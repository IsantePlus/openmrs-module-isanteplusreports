...
<script type="text/javascript">
    ...
    function generateExcelName() {
        return "PsychoSocialIndicatorReport" + formatDate(new Date()) + ".xls";
    }

    function generatePdfName() {
        return "PsychoSocialIndicatorReport" + formatDate(new Date()) + ".pdf";
    }
            ...
            <table id="indicators" style="display:block; width: 100%; padding-top: 11px;">
                ...
                <tbody>
                    <tr>
                     ...
                     <%  manager.psychoSocialIndicators.each { indicator -> %>
